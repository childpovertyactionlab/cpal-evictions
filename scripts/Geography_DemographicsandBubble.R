...
districts <- st_read("data/Current_Districts_2023.geojson")
...
risd_elem <- st_read("C:/Users/erose/CPAL Dropbox/Data Library/Richardson Independent School District/School Boundaries/Richardson ISD Elementary School Boundaries 2024-2025.geojson") %>%
