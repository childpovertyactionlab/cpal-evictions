...
#select only the necessary column types and rename them based on NTE data plan
dallas <- import("C:/Users/Michael/CPAL Dropbox/Data Library/Dallas County/Eviction Records/Data/Dallas County Eviction Master/EvictionRecords_Master.csv") %>%
...
dallascouncil <- st_read("C:/Users/Michael/CPAL Dropbox/Data Library/City of Dallas/02_Boundaries and Features/Legislative Boundaries/City Council 2023 Boundaries/Council_Simple.shp") %>%
